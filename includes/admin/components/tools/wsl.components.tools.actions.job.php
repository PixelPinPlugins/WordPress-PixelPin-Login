...
<div class="metabox-holder columns-2" id="post-body">
	<div class="stuffbox">
		...
		<div class="inside">
							...
							if( ! $test )
							{
								?>
									<div class="fade error" style="margin: 20px  0;">
										...
										<p>This may prevent this plugin form working correctly. To fix this, navigate to <b>Tools</b> tab then <b><a href="options-general.php?page=wordpress-pixelpin-login&wslp=tools#repair-tables">Repair WSL tables</a></b>.</p>
									</div>
								<?php
							}
						?>
			...
			<a class="button-secondary" href="options-general.php?page=wordpress-pixelpin-login&wslp=tools">&larr; <?php _wsl_e("Back to Tools", 'wordpress-pixelpin-login') ?></a>
		</div>
	</div>
</div>
<?php
...
WSL NETWORKS:             <?php foreach( $WORDPRESS_PIXELPIN_LOGIN_PROVIDERS_CONFIG as $provider ){ if( get_option( 'wsl_settings_' . $provider['provider_id'] . '_enabled' ) ){ echo strtoupper( $provider['provider_id'] ) . ' '; } } echo "\n"; ?>
...
<div class="metabox-holder columns-2" id="post-body">
	<div class="stuffbox">
		<h3>
			<label><?php _wsl_e("Repair Wordpress PixelPin Login tables", 'wordpress-pixelpin-login') ?></label>
		</h3>
		<div class="inside">
			<p>
				<?php _wsl_e("All Wordpress PixelPin Login tables and fields <em>should</em> be now restored", 'wordpress-pixelpin-login') ?>.
			</p>
			<p>
				<?php _wsl_e("If this still didn't work, please report this as a issue", 'wordpress-pixelpin-login') ?>.
			</p>
			<hr />
			<a class="button-secondary" href="options-general.php?page=wordpress-pixelpin-login&wslp=tools">&larr; <?php _wsl_e("Back to Tools", 'wordpress-pixelpin-login') ?></a>
		</div>
...
<div class="metabox-holder columns-2" id="post-body">
	<div class="stuffbox">
		...
		<div class="inside">
			<p>
				<?php _wsl_e("All Wordpress PixelPin Login tables and stored options are permanently deleted from your WordPress database", 'wordpress-pixelpin-login') ?>.
			</p>
			<p>
				<?php _wsl_e("To delete Wordpress PixelPin Login files from your WordPress website, you may deactivate and uninstall it through the 'Plugins' menu in WordPress", 'wordpress-pixelpin-login') ?>.
			</p>
			<p>
				<?php _wsl_e("Thank you for using Wordpress PixelPin Login", 'wordpress-pixelpin-login') ?>.
			</p>
			<p>
				<?php _wsl_e("Good bye", 'wordpress-pixelpin-login') ?>.
			</p>
			<hr />
			<a class="button-secondary" href="options-general.php?page=wordpress-pixelpin-login&wslp=tools">&larr; <?php _wsl_e("Back to Tools", 'wordpress-pixelpin-login') ?></a>
		</div>
