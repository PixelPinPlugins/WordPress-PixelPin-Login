...
<div class="stuffbox" style="padding:20px">
	<h3 style="padding-left:0px"><?php _wsl_e("Documentation", 'wordpress-pixelpin-login') ?></h3>
	<p>
	...
	<h3 style="padding-left:0px"><?php _wsl_e("FAQs", 'wordpress-pixelpin-login') ?></h3>
	<p>
	...
	<h3 style="padding-left:0px"><?php _wsl_e("Support", 'wordpress-pixelpin-login') ?></h3>
	<p>
		<?php _wsl_e('To get help and support, here is how you can reach me <a href="http://miled.github.io/wordpress-pixelpin-login/support.html" target="_blank">miled.github.io/wordpress-pixelpin-login/support.html</a>', 'wordpress-pixelpin-login') ?>
	</p>
 
	<hr />
	
	<h3 style="padding-left:0px"><?php _wsl_e("Authors", 'wordpress-pixelpin-login') ?></h3>
	<p>
		<?php _wsl_e('WordPress PixelPin Login was created by <a href="http://profiles.wordpress.org/miled/" target="_blank">Mohamed Mrassi</a> (a.k.a Miled) and <a href="https://miled.github.io/wordpress-pixelpin-login/graphs/contributors" target="_blank">contributors</a>', 'wordpress-pixelpin-login') ?>.
	</p>
 
	<hr />
	
	<h3 style="padding-left:0px"><?php _wsl_e("License", 'wordpress-pixelpin-login') ?></h3>
	<p>
		<?php _wsl_e("Except where otherwise noted, <b>WordPress PixelPin Login</b> is distributed under the terms of the MIT license reproduced here", 'wordpress-pixelpin-login') ?>.
	</p>

	<p>
		<?php _wsl_e("In case you're not familiar with The MIT License, it can be summed in three basic things", 'wordpress-pixelpin-login') ?>:
	</p>

	<ul style="margin-left:45px;line-height: 20px;">
		<li><?php _wsl_e("The MIT License (MIT) is compatible with The GNU Public License (GPL) but it is more liberal", 'wordpress-pixelpin-login') ?>.</li>
		<li><?php _wsl_e("Do no hold the plugin authors liable. This software is provided AS IS, WITHOUT WARRANTY OF ANY KIND", 'wordpress-pixelpin-login') ?>.</li>
		<li><?php _wsl_e("You are allowed to use this plugin for whatever purpose, including in commercial projects, as long as the copyright header inside the code is left intact", 'wordpress-pixelpin-login') ?>.</li>
	</ul>
