...
<!DOCTYPE html>
	<head>
		<meta name="robots" content="NOINDEX, NOFOLLOW">
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		<title><?php bloginfo('name'); ?> - <?php _wsl_e("Oops! We ran into an issue", 'wordpress-pixelpin-login') ?>.</title>
		<style type="text/css">
			body {
				background: #f1f1f1;
			}
	...
	<body>
		<div id="error-page">
			<table width="100%" border="0">
				...
				<tr>
					<td align="center"><h4><?php _wsl_e("Oops! We ran into an issue", 'wordpress-pixelpin-login') ?>.</h4></td>
				</tr>
				...
				<tr>
					<td>
						...
						<?php
							...
							{
								?>
									<p class="error-hint"><?php _wsl_e( $notes, 'wordpress-pixelpin-login'); ?></p>
								<?php
							}
						?>
					</td>
				...
				<tr>
					<td>
						<p style="padding: 0;">
							<a href="javascript:xi();" style="float:right"><?php _wsl_e("Details", 'wordpress-pixelpin-login') ?></a>
							<a href="<?php echo home_url(); ?>" style="float:left">&xlarr; <?php _wsl_e("Back to home", 'wordpress-pixelpin-login') ?></a>
						</p>
...
<small>
	<?php _wsl_e("<strong>Note:</strong> This debugging area can be disabled from the plugin settings by setting <b>Development mode</b> to <b>Disabled</b>", 'wordpress-pixelpin-login'); ?>.
</small>
<?php
}
