...
<!DOCTYPE html>
	<head>
		...
		<title><?php _wsl_e("Redirecting...", 'wordpress-pixelpin-login') ?> - <?php bloginfo('name'); ?></title>
		<style type="text/css">
			html {
				background: #f1f1f1;
			}
	...
	<body id="loading-screen" onload="init();">
		<table width="100%" border="0">
			...
			<tr>
				<td align="center">
					<div>
						<?php echo sprintf( _wsl__( "Contacting <b>%s</b>, please wait...", 'wordpress-pixelpin-login'), _wsl__( ucfirst( $provider ), 'wordpress-pixelpin-login') )  ?>
					</div>
				</td>
			</tr>
		</table>
				...
				<?php
					if( $wsl_settings_use_popup == 1 || ! $wsl_settings_use_popup ){
						?>
							if( window.opener )
							{
								window.opener.wsl_wordpress_pixelpin_login({
	...
	<body id="loading-screen" onload="init();">
		<table width="100%" border="0">
			...
			<tr>
				<td align="center">
					<div>
						<?php echo _wsl_e( "Processing, please wait...", 'wordpress-pixelpin-login');  ?>
					</div>
				</td>
			</tr>
		</table>
