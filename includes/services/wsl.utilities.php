							...
							<tr>
								<td valign="top" width="450">
									<?php if( stristr( $caller_name, $keyword ) ): ?>
										<a href="https://github.com/hybridauth/WordPress-PixelPin-Login/search?q=<?php echo $caller_name ; ?>" target="_blank" class="wsl-dev-wslfunc"><?php echo $caller_name; ?></a>
									<?php else: ?>
												...
												<tr>
													<td valign="top" width="270" nowrap class="wsl-dev-usedhook">
														<?php
															...
															{
																?>
																	<a class="wsl-dev-usedwslhook" href="https://github.com/hybridauth/WordPress-PixelPin-Login/search?q=<?php echo $name ; ?>" target="_blank"><?php echo $name ; ?></a>
																<?php
															}
															else
															{
