...
WordPress PixelPin Login allow your visitors to comment and login with pixelpin.

== Description ==

<strong>Wordpress PixelPin Login</strong> allow your website readers and customers to register on using their existing pixelpin accounts IDs, eliminating the need to fill out registration forms and remember usernames and passwords. 

Wordpress PixelPin Login gives you absolute control over users access to your website and comes a list of rules and restrictions for you to setup.

<strong>Easy to customize and integrate</strong> <br>
Wordpress PixelPin Login come with a simple but flexible and fully customizable authentication widget. And if you are a developer or designer then you can customize it to your heart's content.

<strong>Wide variety of providers</strong> <br>
Depending on the audience you're targeting, you can choose from a wide variety of providers and services including: PixelPin networks, Microblogging platforms, Professional networks, Media, Photo sharing, Programmers and Gamers networks.


<strong>Free, unlimited and white-label</strong> <br>
Wordpress PixelPin Login is open-source and completely free. The source code is publicly available on [GitHub](https://github.com/hybridauth/WordPress-PixelPin-Login) for anyone to help and contribute. You are free to use a Wordpress PixelPin Login in commercial projects as long as the copyright header is left intact.

<strong>Special thanks to:</strong>

* [Thenbrent](http://profiles.wordpress.org/users/thenbrent/) the talented developer behind the PixelPin Connect plugin.
...
* [PixelPin Login plugin](https://wordpress.org/plugins/oa-pixelpin-login/) for many borrowed functions.
...
1. Goto the Settings > WP PixelPin Login to get started.

= The easy way =

1. As administrator, goto 'Plugins' then Click on 'Add New',
2. Search for 'WordPress PixelPin Login' then Click on 'Install Now',
3. Wait for it to download, Unpack and to install,
4. Activate the plugin by Clicking on 'Activate Plugin'
5. Goto the Settings > WP PixelPin Login to get started.


== Frequently Asked Questions ==

The user guide and frequently asked questions can be found at http://miled.github.io/wordpress-pixelpin-login/
...
http://miled.github.io/wordpress-pixelpin-login/developer-api-migrating-2.2.html
http://miled.github.io/wordpress-pixelpin-login/developer-api-authentication.html
...
* WSL now display pixelpin apis errors when authentication fails.
...
* WSL now provide an easier access to pixelpin networks apis.
...
* Added documentation for pixelpin apis access (through php code)
...
* RIP Gowalla
* WordPress PixelPin Login is now licensed under The MIT License only (should be GPL compatible) 
