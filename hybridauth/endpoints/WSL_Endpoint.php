...
class WSL_Hybrid_Endpoint extends Hybrid_Endpoint
{
	...
	public static function processAuthStart()
	{
		...
		try {
			...
			WSL_Hybrid_Endpoint::dieError( "412 Precondition Failed", $e->getMessage() . "<br />For more information refer to WSL <a href='http://miled.github.io/wordpress-pixelpin-login/troubleshooting.html' target='_blank'>Troubleshooting</a>" );
		}
	}
	...
	public static function processAuthDone()
	{
		...
		try {
			...
			WSL_Hybrid_Endpoint::dieError( "410 Gone", $e->getMessage() . "<br />For more information refer to WSL <a href='http://miled.github.io/wordpress-pixelpin-login/troubleshooting.html' target='_blank'>Troubleshooting</a>" );
		}
	}
